export default function sketch(p){
  ...
  p.draw = () => 
  {
      ...
      p.beginShape();
      ponto(ensaios.trac,ensaios.compr,p,escala);
      ponto(-ensaios.compr,ensaios.compr,p,escala);
      ponto(-ensaios.compr,-ensaios.trac,p,escala);
      ...
      p.fill(0,0,0,0);
      p.beginShape();
      pontoEnvoltoriaSeguranca(ensaios.trac,ensaios.compr,p,escala,fs);
      pontoEnvoltoriaSeguranca(-ensaios.compr,ensaios.compr,p,escala,fs);
      pontoEnvoltoriaSeguranca(-ensaios.compr,-ensaios.trac,p,escala,fs);
